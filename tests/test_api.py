...
def test_mh_endpoint_default_distribution():
    ...
    response = client.post(
        "/mcmc/mh", json={"iterations": 100, "burn_in": 10, "thin": 1, "seed": 42}
    )
...
def test_seed_reproducibility():
    ...
    response1 = client.post("/mcmc/mh", json={"iterations": 100, "seed": 42})
    response2 = client.post("/mcmc/mh", json={"iterations": 100, "seed": 42})
